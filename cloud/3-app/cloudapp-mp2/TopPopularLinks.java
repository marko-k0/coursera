...
// <<< Don't Change
    ...
    public static class LinkCountMap extends Mapper<Object, Text, IntWritable, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while(st.hasMoreTokens())
                context.write(new IntWritable(Integer.parseInt(st.nextToken())), new IntWritable(1));	
        }
    }
    ...
    public static class TopLinksMap extends Mapper<Text, Text, NullWritable, IntArrayWritable> {
        ...
        // TODO
        private TreeSet<Pair<Integer, Integer>> countLinksMap = new TreeSet<Pair<Integer, Integer>>();
        ...
        public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            countLinksMap.add(new Pair<Integer, Integer>(count, id));

            if (countLinksMap.size() > this.N)
                countLinksMap.remove(countLinksMap.first());
        }   

        @Override
        protected void cleanup(Context context) throws IOException, InterruptedException {
            for (Pair<Integer, Integer> item : countLinksMap) {
