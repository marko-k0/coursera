...
public class ActivityLoaderActivity extends Activity {
    ...
    static private final int EXPLICIT_CODE_42 = 42;
	...
	private void startExplicitActivation() {
		...
		Intent explicitIntent = new Intent(this.getBaseContext(), ExplicitlyLoadedActivity.class);
        startActivityForResult(explicitIntent, EXPLICIT_CODE_42);
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK && requestCode == EXPLICIT_CODE_42) {
