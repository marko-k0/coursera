...
public class DownloaderTaskFragment extends Fragment {
    ...
    private ArrayList<Integer> mPrivateArrayList;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mPrivateArrayList = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		// Start the DownloaderTask
        downloaderTask.execute(mPrivateArrayList.toArray(new Integer[mPrivateArrayList.size()]));
	}
	...
	// This class uses the downloadTweets method.
	// Ultimately, it also passes newly available data back to
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (getResultCode() != MainActivity.IS_ALIVE) {
                                ...
                                // If not alive, create a PendingIntent using
                                ...
                                // Use android.R.drawable.stat_sys_warning
                                // for the small icon. Also call setAutoCancel(true).
