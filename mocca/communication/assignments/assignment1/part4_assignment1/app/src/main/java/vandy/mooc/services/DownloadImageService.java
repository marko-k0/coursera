...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        // to the image file back tDownloadImagesBoundService calledo the MainActivity, and (4) putting
    ...
    public void onHandleIntent(Intent intent) {
        ...
        Uri pathToImageFile = Utils.downloadImage(getApplicationContext(), url, directoryPathname);

        // Extract the Messenger stored as an extra in the intent under the key MESSENGER.
        Messenger messenger = (Messenger)intent.getExtras().get(MESSENGER);

        // Send the path to the image file back to the MainActivity via the messenger.
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        if(pathToImageFile != null)
            ...
            message.arg1 = MainActivity.RESULT_CANCELED;
