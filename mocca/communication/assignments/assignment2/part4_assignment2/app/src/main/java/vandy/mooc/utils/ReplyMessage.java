...
public class ReplyMessage extends RequestReplyMessageBase {
    ...
    public static ReplyMessage makeReplyMessage(Uri pathToImageFile,
        ...
        // Set the result code to indicate whether the download succeeded or failed.
        if(pathToImageFile != null) {
            replyMessage.setResultCode(MainActivity.RESULT_OK);
            ...
            replyMessage.setResultCode(MainActivity.RESULT_CANCELED);
        }
